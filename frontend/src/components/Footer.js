      ...
      <div className="footer-container">
        <div className="footer-grid">
          ...
          <div className="footer-section">
            <h3 className="footer-title">Oupafamilly</h3>
            <p className="footer-description">
              La communauté gaming où le fun, la compétition et l'esprit familial se rencontrent.
            </p>
          ...
          {/* Games */}
          <div className="footer-section">
            <h4 className="footer-subtitle">Nos Jeux</h4>
            <ul className="footer-links">
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              ...
              <li><a href="#">Rejoindre la famille</a></li>
            </ul>
          </div>
        </div>

        <div className="footer-bottom">
          <p>&copy; 2025 Oupafamilly. Tous droits réservés.</p>
